...
* Use [GitHub](https://github.com/) for creating a reproducible research document.
    ...
    - My GitHub Username is: _jongyeopWoo_

* Obtain, Clean, Transform, and Visualize dataset using the R programming language.

* Interpret and predict dataset trends using using statistical inference and models.
